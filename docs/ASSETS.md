...
+28 f32 scale
```
All **590** shipped records carry a sound (525) or a sprite (220) or both — none carry neither — with 0 malformed windows and every attach code in range (`verify.py: ctl effects`) |
