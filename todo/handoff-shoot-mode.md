...
| **8.3 THE HUD, part 1**: screen 34 over the frame - ring count, weapon name, ammo, fills, crosshair | **done 2026-09-10** — `engine: shoot hud`; the turning models, health bar and minimap not yet; not yet played |
