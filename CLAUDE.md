...
| todo/slider.md | ~13k | the SLIDER (next-tasks 16): the sneak's transport, the flight model, how a ride is entered and ends, and where a called one comes to. Five steps, four done |
