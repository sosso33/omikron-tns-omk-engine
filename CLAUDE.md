...
| todo/slider.md | ~15k | the SLIDER (next-tasks 16): the sneak's transport, the flight model, how a ride is entered and ends, where a called one comes to and where it is put. Six steps, five done |
