...
inline constexpr std::uint32_t kCbMultiplanDestroyYes  = 0x004B08C0u;   // Oui: request 6
inline constexpr std::uint32_t kCbMultiplanDestroyNo   = 0x004B0980u;   // Non
inline constexpr std::uint32_t kListMultiplanDestroy   = 0x004E57C0u;   // the confirm's four items
inline constexpr std::uint32_t kTextMultiplanRowName   = 0x004B0C30u;   // its second line
